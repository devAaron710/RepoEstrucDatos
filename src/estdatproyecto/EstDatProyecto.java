...
public class EstDatProyecto {
    ...
    public static void main(String[] args) throws IOException {
        ...
        banco.crearTXT();
        int cantidadCajas = banco.getCantidadCajas();
        //instancia de objeto cola
        Caja caja = new Caja(cantidadCajas);
        ...
        while (continuar) {
            ...
            switch (opcion) {
                case "1": // Crear tiquete
                    ...
                    Tiquete tiquete = new Tiquete(nombre, id, edad, tipo, tramite, 0);
                    //insertar el tiquete en la cola
                    caja.insertarTiquete(tiquete);
                    break;

                case "2": //Atender tiquete
                    //Solicitar el # de caja para atender el tiquete
                    String cajaStr = JOptionPane.showInputDialog("Ingrese el numero de caja para atender el tiquete:");
                    int numeroCaja = Integer.parseInt(cajaStr);
                    caja.atenderTiquete(numeroCaja);
                    break;
                ...
                case "5": //Ver reportes
                    ...
                    reporte.consultar(cantidadCajas);
                    break;
                case "6": //salir
                    continuar = false;
                    break;
